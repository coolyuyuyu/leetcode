...
public:
    int palindromePartition(string s, int k) {
        ...
        // cnts[i][j]: the minimal number of characters from s[i:j] that you need to change to make s[i:j] palindrome
        ...
        // dp[i][numParts]: the minimal number of characters that you need to change to divide s[1:i] into numParts palindromic substring
